...
\def\lecturename{Cấu trúc rời rạc cho KHMT}

\title{\insertlecture}

\author{N.T.Toàn, P.N.Minh, L.H.Anh, T.Đ.G.Hải, H.Đ.Thịnh, N.P.Thịnh}
...
\setbeamertemplate{title page}
{
  ...
  \fi%     
  \vskip1em\par
  \emph{\lecturename}\ vào \insertdate\par
  \vskip0pt plus1filll
